...
use celestica_crdt::{HLCTimestamp, Key};
use celestica_node::NodeId;
use celestica_rpc::Channel;
...
///
/// This can be very useful if you wish to extend Celestica's storage system
...
impl PutContext {
    ...
    /// to communicate with services ran by the Celestica server.
    ///
    /// Additional services can be registered to the server ran by Celestica
